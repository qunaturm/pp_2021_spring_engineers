...
#ifndef MODULES_TASK_1_KHISMATULINA_K_GRADIENT_TBB_H_
#define MODULES_TASK_1_KHISMATULINA_K_GRADIENT_TBB_H_
#include <vector>
...
#endif  // MODULES_TASK_1_KHISMATULINA_K_GRADIENT_TBB_H_
